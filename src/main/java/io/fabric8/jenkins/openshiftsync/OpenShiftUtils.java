...
public class OpenShiftUtils {
    ...
    public synchronized static void shutdownOpenShiftClient() {
        if (openShiftClient != null) {
            ...
            logger.info("Cancelling all requests in the dispatcher thread");
            dispatcher.cancelAll();
            ConnectionPool connectionPool = httpClient.connectionPool();
            logger.info("Cleaning all connexions in the connexion pool");
            ...
            try {
                ...
                logger.severe("Error while shuting down service Executor " + e);
                e.printStackTrace();
            }
